...
export const QUOTES = [
  ...
  "If we feel disheartened or depressed, visualizing a horse running through a beautiful meadow will stimulate a sense of empowerment. It gives us lightness and levity, as though anything is possible. This incredibly potent life-force is windhorse. We always have the opportunity to raise it here and now.",
  "We receive lots of good advice from others, but it primarily affects this single life. The dharma helps us in all lives. It transcends the notions of time and space.",
