...
<!--
This file contains member-only events visible only to signed-in users.
Same format as EVENTS.md.

Title: Event title
Date: YYYY-MM-DD
ToDate: YYYY-MM-DD (optional, for multi-day events)
Image: filename.jpg (optional)
Description: Event description

All events are all-day events by default.
-->
